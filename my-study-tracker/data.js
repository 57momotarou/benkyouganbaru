...
const ALL_SUBJECTS = [
  // === 専門科目 - 専門基礎 ===
  { code: 'BA101',    name: '企業経営入門',                        category: '専門', type: '専門基礎', credits: 2, lessons: 15, deadline_type: '専門', available: ['春', '秋'], open_type: '一斉', is_enshu: false, required: true },
  { code: 'BA102',    name: '会計簿記入門',                        category: '専門', type: '専門基礎', credits: 2, lessons: 15, deadline_type: '専門', available: ['春', '秋'], open_type: '一斉', is_enshu: false },
  ...
  { code: 'BA202',    name: '管理会計',                            category: '専門', type: '専門基礎', credits: 2, lessons: 15, deadline_type: '専門', available: ['春', '秋'], open_type: '一斉', is_enshu: false },
  ...
  // === 専門科目 - 専門応用 ===
  { code: 'BA301',    name: '事業創造評論',                        category: '専門', type: '専門応用', credits: 2, lessons: 15, deadline_type: '専門', available: ['春', '秋'], open_type: '順次', is_enshu: false },
  ...
  { code: 'CS153',    name: 'Web入門',                             category: '専門', type: '専門基礎', credits: 2, lessons: 15, deadline_type: '専門', available: ['春', '秋'], open_type: '一斉', is_enshu: false, required: true },
  { code: 'CS154',    name: '情報セキュリティ入門',                category: '専門', type: '専門基礎', credits: 2, lessons: 15, deadline_type: '専門', available: ['春', '秋'], open_type: '一斉', is_enshu: false, required: true },
  { code: 'CS156',    name: 'デジタル技術と情報化社会',            category: '専門', type: '専門基礎', credits: 2, lessons: 15, deadline_type: '専門', available: ['春', '秋'], open_type: '一斉', is_enshu: false, required: true },
  ...
  // === 外国語科目（英語）===
  { code: 'ENGL101E', name: '基礎英語Ⅰ',   category: '外国語', type: '英語', credits: 2, lessons: 15, deadline_type: '外国語', available: ['春', '秋'], open_type: '一斉', term: '通期', is_enshu: true, required: true },
  { code: 'ENGL151E', name: '基礎英語Ⅱ',   category: '外国語', type: '英語', credits: 2, lessons: 15, deadline_type: '外国語', available: ['春', '秋'], open_type: '一斉', term: '通期', is_enshu: true, required: true },
  { code: 'ENGL201E', name: '中級英語Ⅰ',   category: '外国語', type: '英語', credits: 2, lessons: 15, deadline_type: '外国語', available: ['春', '秋'], open_type: '一斉', term: '通期', is_enshu: true, required: true },
  { code: 'ENGL251E', name: '中級英語Ⅱ',   category: '外国語', type: '英語', credits: 2, lessons: 15, deadline_type: '外国語', available: ['春', '秋'], open_type: '一斉', term: '通期', is_enshu: true, required: true },
  ...
  { code: 'PM101',    name: 'プロジェクトマネジメント入門',        category: '専門', type: '専門基礎', credits: 2, lessons: 15, deadline_type: '専門', available: ['春', '秋'], open_type: '一斉', is_enshu: false, required: true },
  ...
  { code: 'TH401E',   name: 'ゼミナール',                             category: '専門', type: '専門応用', credits: 4, lessons: 15, deadline_type: '専門', available: ['春', '秋'], open_type: '順次', is_enshu: true },

  // === 教養科目（キャリアデザイン分野）===
  { code: 'SD101E',   name: 'スタディスキル入門',                  category: '教養', type: 'キャリアデザイン', credits: 1, lessons: 8, deadline_type: '教養', available: ['春', '秋'], open_type: '順次', term: '前期', is_enshu: true, required: true },
...
const BADGES = [
  ...
  { id: 'badge-it-bronze', name: 'IT総合学基礎', level: 'bronze', category: '専門',
    requirements: { codes: ['CS101','CS102','CS103','CS153','CS154','CS156','PM101','BA101'] } },

  // テクノロジー基礎Ⅰ（4科目：ブロンズ）
  { id: 'badge-tech1-bronze', name: 'テクノロジー基礎Ⅰ', level: 'bronze', category: '専門',
    requirements: { prerequisite: 'badge-it-bronze', codes: ['CS151','CS201','CS252E'] } },

  // 数学基礎（4科目：ブロンズ）
  { id: 'badge-math-bronze', name: '数学基礎', level: 'bronze', category: '専門',
    requirements: { prerequisite: 'badge-it-bronze', codes: ['MATH201','MATH251'] } },

  // テクノロジー基礎Ⅱ（シルバー）
  { id: 'badge-tech2-silver', name: 'テクノロジー基礎Ⅱ', level: 'silver', category: '専門',
    requirements: { prerequisite: 'badge-tech1-bronze', codes: ['CS251E','CS253E','CS203E'] } },

  // ゴールド4種
  { id: 'badge-network-gold', name: 'ネットワーク', level: 'gold', category: '専門',
    requirements: { prerequisite: 'badge-tech2-silver', codes: ['CS202','CS302','CS307','CS360E'] } },
  { id: 'badge-security-gold', name: 'セキュリティ', level: 'gold', category: '専門',
    requirements: { prerequisite: 'badge-tech2-silver', codes: ['CS304','CS305','CS307','CS361'] } },
  { id: 'badge-software-gold', name: 'ソフトウェア', level: 'gold', category: '専門',
    requirements: { prerequisite: 'badge-tech2-silver', codes: ['CS303E','CS351E','CS358E','CS359E'] } },
  { id: 'badge-ai-gold', name: 'AI', level: 'gold', category: '専門',
    requirements: { prerequisite: 'badge-tech2-silver', codes: ['MATH201','MATH251','CS352E','CS353','CS354E','CS356E'] } },
  ...
  { id: 'badge-biz-bronze', name: 'ビジネス基礎', level: 'bronze', category: '専門',
    requirements: { prerequisite: 'badge-it-bronze', codes: ['ECON101','BA102','BA151','BA152'] } },

  // ビジネス基礎Ⅱ（シルバー）
  { id: 'badge-biz-silver', name: 'ビジネス基礎Ⅱ', level: 'silver', category: '専門',
    requirements: { prerequisite: 'badge-biz-bronze', codes: ['BA201','BA253','BA356E'] } },

  // ゴールド5種
  { id: 'badge-genai-gold', name: '生成AI活用', level: 'gold', category: '専門',
    requirements: { prerequisite: 'badge-biz-silver', codes: ['BA253','BA252','BA357E','BA356E'] } },
  ...
  { id: 'badge-mgmt-gold', name: '管理', level: 'gold', category: '専門',
    requirements: { prerequisite: 'badge-biz-silver', codes: ['PM301','PM351E','BA202'] } },
  ...
  { id: 'badge-academic-literacy', name: 'アカデミックリテラシー', level: 'bronze', category: '教養',
    requirements: { codes: ['SD101E','CS104E'] } },
  { id: 'badge-academic-writing', name: 'アカデミックリテラシー（シルバー）', level: 'silver', category: '教養',
    requirements: { prerequisite: 'badge-academic-literacy', codes: ['SD113','SD106','SD301E','SD302E'] } },
  { id: 'badge-startup-kyoyo', name: '教養スタートアップ', level: 'bronze', category: '教養',
    requirements: { codes: ['SD116','GENS101','GEHM101','GESS101'] } },
  ...
  { id: 'badge-chinese-bronze', name: '中国語基礎', level: 'bronze', category: '外国語',
    requirements: { codes: ['CHIN101E','CHIN202E'] } },
];
...
const ATTENDANCE_2026_SPRING = {
  ...
  study_skill: [
    ...
    { start: '2026-04-02', end: '2026-06-02T12:00:00' },  // コマ8
  ],
};
...
const SEMESTERS = [
  ...
  { id: 2, name: '2026年度秋学期', year: 2026, season: '秋', start: '2026-10-01', end: '2027-02-06',
    exams: [
      { label: 'スタディスキル入門 期末', date: '2026-11-24' },
      { label: '教養前期科目 期末', date: '2026-12-14' },
      { label: '専門・外国語・教養後期 期末', date: '2027-02-06' },
    ], seiseki: '2027-03-01' },
